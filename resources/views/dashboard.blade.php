        ...
        <div class="right_col" role="main">
          ...
          <div class="tile_count">
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> User Id</span>
              <div class="count">{{ Auth::user()->id }}</div>
              <span class="count_bottom"><i class="green"></i>{{ Auth::user()->created_at }}</span>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
                    <ul class="quick-list">
                      ...
                      <li>
                          <form action="{{route('logout')}}"><i class="fa fa-area-chart"></i><a href="/">Logout</a></form>
                      </li>
                    </ul>
